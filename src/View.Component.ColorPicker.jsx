...
const ColorPicker = (props) => {
  ...
  return <Grid container spacing={2}>
    ...
    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'center' }}>
      <Button variant='contained' style={{ background: rgbaString }} onClick={() => navigator.clipboard.writeText(rgbaString)}>
        <span style={{ mixBlendMode: 'difference' }}>{rgbaString}</span>
      </Button>
    </Grid>
  </Grid>
}
