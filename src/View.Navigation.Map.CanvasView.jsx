  ...
  return <Grid container spacing={0}>
    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: 30 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Slider size='small' style={{ width: 120 }} value={ImitationPageCanvas.state.store.view.scaleX} onChange={(e, v) => { onScaleXChange(v) }} min={0.02} max={24} step={0.01} />
      </div>
    </Grid>
    ...
    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: 30 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Slider size='small' style={{ width: 120 }} value={ImitationPageCanvas.state.store.view.scaleY} onChange={(e, v) => { onScaleYChange(v) }} min={0.02} max={24} step={0.01} />
      </div>
    </Grid>
    ...
    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: 30 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Slider size='small' style={{ width: 120 }} value={ImitationPageCanvas.state.store.view.translateX} onChange={(e, v) => { onTranslateXChange(v) }} min={Math.min(ImitationPageCanvas.state.store.view.translateX, -1000)} max={Math.max(ImitationPageCanvas.state.store.view.translateX, 1000)} step={1} />
      </div>
    </Grid>
    ...
    <Grid item xs={12} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: 30 }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Slider size='small' style={{ width: 120 }} value={ImitationPageCanvas.state.store.view.translateY} onChange={(e, v) => { onTranslateYChange(v) }} min={Math.min(ImitationPageCanvas.state.store.view.translateY, -1000)} max={Math.max(ImitationPageCanvas.state.store.view.translateY, 1000)} step={1} />
      </div>
    </Grid>
  </Grid>
}
